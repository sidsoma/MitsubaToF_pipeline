...
if run_diffuse_test:
    exp_name = 'diffuse_patch_test'
    scene_name = '/u/sidsoma/mirror_scanning_iccp24/scenes/test_patch.xml'
    numSamples = 16
else:
    exp_name = 'mirror_test_32x32'
    scene_name = '/u/sidsoma/mirror_scanning_iccp24/scenes/mirror.xml'
    numSamples = 3200

save_dir = '/u/sidsoma/mirror_scanning_iccp24/experiments'
...
subprocess.call(f'su - {username}', shell=True)
